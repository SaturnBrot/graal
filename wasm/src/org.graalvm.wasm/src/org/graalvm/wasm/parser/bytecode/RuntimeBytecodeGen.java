...
public class RuntimeBytecodeGen extends BytecodeGen {
    ...
    /**
     * Adds a tail call instruction to the bytecode. If the functionIndex fits into an u8 value,
     * a tail_call_u8 and an u8 value are added. Otherwise, a tail_call_i32 and an i32 value are
     * added.
     *
    ...
    /**
     * Adds an indirect tail call instruction to the bytecode. If the typeIndex, and
     * tableIndex fit into an u8 value, a tail_call_indirect_u8 and two u8 values are added.
     * Otherwise, a tail_call_indirect_i32 and two i32 values are added. In both cases, a 2-byte
     * profile is added.
     *
